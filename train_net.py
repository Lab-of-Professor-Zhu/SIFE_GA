...
def test_volleyball(data_loader, model, device, epoch, cfg):
    ...
    with torch.no_grad():
        for batch_data_test in data_loader:
            ...
            f = 'data.txt'
            with open(f, "a") as e:
                e.write(str(epoch) + ":" + " actions_in:" + str(actions_in.int()) + "\n") 
                e.write(str(epoch) + ":" + " actions_labels:" + str(actions_labels.int()) + "\n")
                e.write(str(epoch) + ":" + " activities_in:" + str(activities_in.int()) + "\n")
                e.write(str(epoch) + ":" + " activities_labels:" + str(activities_labels.int()) + "\n")
